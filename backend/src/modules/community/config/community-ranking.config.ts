export const COMMUNITY_RANKING_CONFIG = {
  weights: {
    ...
    onlineMembers: 0.20,    // Real-time active users inside the community right now
    recentMessages: 0.15,   // Chat activity velocity
    growth: 0.10,           // Member acquisition growth rate
    friendPresence: 0.10,   // Online friends currently exploring or visiting inside
  ...
  clusterCategories: [
    ...
    { id: 'c-technology', name: 'Technology', category: 'Technology', theme: 'AI Explorers, Nomadic Tech', color: 'stroke-indigo-500 fill-indigo-500/20', glow: 'rgba(99, 102, 241, 0.4)', icon: '💻' },
    { id: 'c-music', name: 'Music', category: 'Music', theme: 'Campfire Jams, Acoustic Trails', color: 'stroke-yellow-500 fill-yellow-500/20', glow: 'rgba(234, 179, 8, 0.4)', icon: '🎸' },
    { id: 'c-wellness', name: 'Wellness', category: 'Wellness', theme: 'Sunrise Yoga, Meditation Woods', color: 'stroke-teal-500 fill-teal-500/20', glow: 'rgba(20, 184, 166, 0.4)', icon: '🧘' },
    { id: 'c-nature', name: 'Nature', category: 'Nature', theme: 'Botanical Walks, Bird Watching', color: 'stroke-green-500 fill-green-500/20', glow: 'rgba(34, 197, 94, 0.4)', icon: '🌲' },
  ],
};
