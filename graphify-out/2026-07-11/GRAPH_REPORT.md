# Graph Report - wandercall_v3  (2026-07-11)

## Corpus Check
- 362 files · ~238,592 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2178 nodes · 5063 edges · 116 communities (96 shown, 20 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0def2fcb`
...
- [[_COMMUNITY_page.tsx|page.tsx]]
- [[_COMMUNITY_ChatEventDispatcher|ChatEventDispatcher]]
...
- [[_COMMUNITY_AdventureDNA.tsx|AdventureDNA.tsx]]
- [[_COMMUNITY_CommunityDashboard|CommunityDashboard]]
- [[_COMMUNITY_socket.ts|socket.ts]]
- [[_COMMUNITY_CampfireEventDispatcher|CampfireEventDispatcher]]
- [[_COMMUNITY_Campfires.tsx|Campfires.tsx]]
- [[_COMMUNITY_compilerOptions|compilerOptions]]
- [[_COMMUNITY_campfire.ts|campfire.ts]]
- [[_COMMUNITY_finalUpdatePage.js|finalUpdatePage.js]]
- [[_COMMUNITY_post.service.ts|post.service.ts]]
- [[_COMMUNITY_campfire.module.ts|campfire.module.ts]]
- [[_COMMUNITY_page.tsx|page.tsx]]
- [[_COMMUNITY_useCampfire.ts|useCampfire.ts]]
- [[_COMMUNITY_updatePageProperly.js|updatePageProperly.js]]
- [[_COMMUNITY_ChatEventDispatcher|ChatEventDispatcher]]
- [[_COMMUNITY_ChatController|ChatController]]
- [[_COMMUNITY_1. Backend Architecture (NestJS + TypeORM + Redis + Socket.io)|1. Backend Architecture (NestJS + TypeORM + Redis + Socket.io)]]
- [[_COMMUNITY_page.tsx|page.tsx]]
- [[_COMMUNITY_getHashColor|getHashColor]]
- [[_COMMUNITY_updateCampfiresPage.js|updateCampfiresPage.js]]
- [[_COMMUNITY_CommunityController|CommunityController]]
- [[_COMMUNITY_fixPageTS.js|fixPageTS.js]]
- [[_COMMUNITY_updateCampfireDetail.js|updateCampfireDetail.js]]

## God Nodes (most connected - your core abstractions)
1. `CommunityEventDispatcher` - 49 edges
2. `useAppSelector` - 48 edges
3. `CampfireEntity` - 37 edges
4. `UserProfileEntity` - 33 edges
5. `UserRepository` - 33 edges
6. `InteractionRepository` - 32 edges
7. `PostEntity` - 30 edges
8. `CommunityEntity` - 28 edges
9. `FollowRepository` - 28 edges
10. `MessageEntity` - 27 edges
...
Cohesion: 0.15
Nodes (15): ProfilePage(), ExplorerProfilePage(), CompanionAvatarProps, ProfileRenderer(), ProfileRendererProps, useUploadCoverImageMutation(), useFollowersInfiniteQuery(), useFollowingInfiniteQuery() (+7 more)
...
Cohesion: 0.05
Nodes (38): dependencies, axios, date-fns, framer-motion, lenis, livekit-client, @livekit/components-react, lucide-react (+30 more)

### Community 9 - "useUserMutations.ts"
Cohesion: 0.12
Nodes (10): CommunityMemberEntity, CommunityMemberStatus, CommunityRoleEntity, CommunityMemberRepository, CommunityRepository, CommunityRoleRepository, CommunityAuditService, CommunityPermissionService (+2 more)
...
Cohesion: 0.07
Nodes (3): FeedEventDispatcher, PostRepository, PostService

### Community 12 - "User Backend Module"
Cohesion: 0.15
Nodes (8): DISCOVERY_CONFIG, ExplorerCircleEdge, ExplorerCircleNode, ExplorerCirclesGraphResponse, FollowEntity, UserProfileEntity, FollowRepository, RelationshipService

### Community 13 - "Feed Backend Module"
Cohesion: 0.19
Nodes (7): FeedImpressionEntity, PostCommentEntity, PostLikeEntity, UserAuthorAffinityEntity, UserInterestEntity, UserPostStateEntity, FeedModule

### Community 14 - "Client Store Module"
Cohesion: 0.11
Nodes (14): campfireSlice, CampfireUiState, initialState, communityDiscoverySlice, CommunityDiscoveryState, initialState, communityWizardSlice, CommunityWizardState (+6 more)

### Community 15 - "Backend Package Module"
Cohesion: 0.06
Nodes (31): dependencies, bcrypt, class-transformer, class-validator, cloudinary, ioredis, livekit-server-sdk, @nestjs/common (+23 more)

### Community 16 - "Campfires Client Module"
Cohesion: 0.11
Nodes (21): CampfireRoom, CampfiresPage(), CARD_GRADIENTS, CATEGORIES, CompanionAvatarProps, FloatingEmoji, Listener, MOCK_DNA_METRICS (+13 more)
...
Cohesion: 0.09
Nodes (7): COMMUNITY_RANKING_CONFIG, CommunityEventDispatcher, CommunityEvents, ActiveCohortUser, CommunityGalaxySubscriber, CommunitySearchSubscriber, CommunityStatisticsSubscriber
...
Cohesion: 0.10
Nodes (22): ALL_COMMUNITIES, CLUSTER_METADATA, ClusterMeta, CommunitiesPage(), CommunityNode, CommunityTrophy, CompanionOrbitNode, JoinedCommunity (+14 more)

### Community 22 - "store.ts"
Cohesion: 0.09
Nodes (14): CommunityJoinPolicy, CommunityStatus, CommunityVisibility, AuthUser, GetUser, CreateCommunityDto, UpdateCommunityDto, UpdateCommunitySettingsDto (+6 more)
...
Cohesion: 0.20
Nodes (12): CampfireInfoPanel(), CampfireInfoPanelProps, CATEGORIES, MOODS, LivePreviewPanelProps, SmartSchedulerPanel(), SmartSchedulerPanelProps, CampfireDraftState (+4 more)
...
Cohesion: 0.11
Nodes (7): SearchController, UserRecommendationCacheEntity, UserSearchHistoryEntity, SearchModule, SocialDiscoveryService, UserSearchQueryDto, UserSearchService

### Community 28 - "Client App Module"
Cohesion: 0.13
Nodes (3): MessageResponseDto, MessageRepository, ChatService

### Community 29 - "Client Experiences Module"
Cohesion: 0.16
Nodes (22): CommunityDashboard(), CommunityNode, VirtualizedMessageList(), CommunityMembersModal(), CommunityMembersModalProps, MemberDetailsControlCenter(), MemberDetailsControlCenterProps, useCommunityDefaultConversation() (+14 more)
...
Cohesion: 0.36
Nodes (7): ChatContainerProps, MessageItem(), MessageItemProps, MessageList(), MessageListProps, ChatMessage, useAutoScroll()

### Community 34 - "UserRepository"
Cohesion: 0.20
...
Cohesion: 0.12
Nodes (4): IPresenceService, PresenceStatus, UserPresence, PresenceService

### Community 59 - "PresenceService"
Cohesion: 0.10
Nodes (21): ChatMessage, useChatConversation(), UseChatConversationOptions, COMMUNITY_CHAT_QUERY_KEYS, useCommunityMessages(), CHAT_QUERY_KEYS, SendMessageParams, useMessages() (+13 more)
...
Cohesion: 0.08
Nodes (6): CurrentUser, CommunityInviteEntity, CommunityInviteStatus, CommunityInviteRepository, CommunityInviteService, CommunityMembershipService
...
Cohesion: 0.14
Nodes (21): LoginPage(), SignupPage(), useGoogleAuthMutation(), useLoginMutation(), useLogoutMutation(), useResendVerificationMutation(), useSignupMutation(), useVerifyEmailMutation() (+13 more)

### Community 71 - "page.tsx"
Cohesion: 0.16
Nodes (9): geistMono, geistSans, metadata, AUTH_ONLY_ROUTES, AuthGuard(), GUEST_ONLY_ROUTES, SmoothScroll(), SmoothScrollProps (+1 more)
...
Cohesion: 0.15
Nodes (4): CompleteProfileRequestDto, PublicProfileResponseDto, RelationshipResponseDto, UpdateProfileRequestDto
...
Cohesion: 0.19
Nodes (14): REDIS_KEYS, AuthUser, GetUser, ConversationResponseDto, ErrorAckDto, ParticipantDto, SendMessageAckDto, AttachmentDto (+6 more)

### Community 77 - "page.tsx"
Cohesion: 0.13
Nodes (5): CommunityAuditAction, CommunityAuditLogEntity, CommunityBanEntity, CommunityAuditLogRepository, CommunityBanRepository
...
Cohesion: 0.17
Nodes (10): AppModule, AuthModule, ChatModule, CommunityRoomEntity, CommunityRoomType, ConversationMemberStateEntity, CommunityModule, PrivacyModule (+2 more)

### Community 83 - "CommunityInviteRenderer.tsx"
Cohesion: 0.23
Nodes (11): CommunityInviteMetadata, CommunityInviteRenderer(), getMessageRenderer(), MESSAGE_RENDERER_REGISTRY, MessageRenderer, MessageRendererProps, useAcceptInvite(), useCommunity() (+3 more)

### Community 84 - "recommendation.engine.ts"
Cohesion: 0.48
Nodes (6): PERMISSION_LIST, RoleMatrixEditor(), useAllRoles(), useCreateRole(), useDeleteRole(), useUpdateCustomRole()

### Community 87 - "page.tsx"
Cohesion: 0.32
Nodes (7): CreatePostRequestDto, PostAuthorType, PostStatus, PostVisibility, InteractionType, CreatePostParams, UpdatePostParams

### Community 93 - "PostCommentEntity"
Cohesion: 0.05
Nodes (26): CampfireModule, CAMPFIRE_ERROR_MESSAGES, CampfireCategory, CampfireMood, CampfireParticipantRole, CampfireParticipantStatus, CampfireStatus, CampfireVisibility (+18 more)

### Community 94 - "AdventureDNA.tsx"
Cohesion: 0.21
Nodes (10): CATEGORY_STYLES, CreateCommunityPage(), Friend, LocationData, TEMPLATE_WALLPAPERS, RelationshipState, useCategories(), useCreateCommunity() (+2 more)

### Community 95 - "CommunityDashboard"
Cohesion: 0.25
Nodes (7): communityApi, CommunityDto, CommunityMemberDto, CommunityStatisticsDto, CreateCommunityDto, UpdateCommunityDto, UpdateCommunitySettingsDto

### Community 96 - "socket.ts"
Cohesion: 0.28
Nodes (6): connectSocket(), getSocket(), CampfireSessionContext, CampfireSessionContextValue, CampfireSessionProvider(), useCampfireSessionManager()

### Community 97 - "CampfireEventDispatcher"
Cohesion: 0.29
Nodes (5): RANKING_CONFIG, RankingEngine, ScoringContext, FeedCursor, FeedQueryDto

### Community 98 - "Campfires.tsx"
Cohesion: 0.20
Nodes (9): AudioMessagePlayer(), Achievement, ActiveQuest, LadderStep, LeaderboardUser, QuestsPage(), QuestStory, Region (+1 more)

### Community 99 - "compilerOptions"
Cohesion: 0.28
Nodes (7): InviteModal(), InviteModalProps, useFriends(), useInviteMember(), communityMembershipSlice, CommunityMembershipState, initialState

### Community 100 - "campfire.ts"
Cohesion: 0.16
Nodes (8): Campfire, campfireApi, CampfireCategory, CampfireDiscoveryResponse, CampfireMood, CampfireStatus, CampfireVisibility, CreateCampfireDto

### Community 101 - "finalUpdatePage.js"
Cohesion: 0.13
Nodes (14): content, createEnd, createStart, deleteStart, effectEnd, effectStart, filePath, fs (+6 more)

### Community 102 - "post.service.ts"
Cohesion: 0.18
Nodes (4): FeedController, CommentRequestDto, FeedQueryDto, UpdatePostRequestDto

### Community 103 - "campfire.module.ts"
Cohesion: 0.33
Nodes (6): EMPTY_STATE, formatInboxTime(), formatMessagePreview(), FriendInboxState, useChatInbox(), useConversations()

### Community 104 - "page.tsx"
Cohesion: 0.14
Nodes (17): ChatContainer(), CampfirePresenceToast(), CampfirePresenceToastProps, CampfirePresenceToastItem, useCampfirePresenceQueue(), CampfireRoom, CampfireRoomPage(), CompanionAvatarProps (+9 more)

### Community 105 - "useCampfire.ts"
Cohesion: 0.50
Nodes (4): ACTION_COLOR_MAP, AuditLogsTable(), AuditLogsTableProps, useCommunityAuditLogs()

### Community 106 - "updatePageProperly.js"
Cohesion: 0.15
Nodes (12): content, createEnd, createStart, effectEnd, effectStart, filePath, fs, hostedStart (+4 more)

### Community 107 - "ChatEventDispatcher"
Cohesion: 0.20
Nodes (3): ChatEventDispatcher, CommunityChatService, MessageService

### Community 109 - "1. Backend Architecture (NestJS + TypeORM + Redis + Socket.io)"
Cohesion: 0.20
Nodes (9): 1.1 Community Module Redesign, 1.2 The "Guest" Role Injection Pattern, 1.3 Event-Driven Moderation, 1. Backend Architecture (NestJS + TypeORM + Redis + Socket.io), 2.1 Deduplication & Synchronization, 2.2 Galaxy UI Rendering, 2. Frontend Architecture (React + TanStack Query + Redux), 3. Recommended Next Steps (+1 more)
...
### Community 111 - "getHashColor"
Cohesion: 0.20
Nodes (10): MessageComposer(), MessageComposerProps, CompanionAvatar(), CompanionAvatar(), CompanionAvatar(), CompanionAvatar(), CompanionAvatar(), CompanionAvatarProps (+2 more)

### Community 112 - "updateCampfiresPage.js"
Cohesion: 0.29
Nodes (6): content, createFuncEnd, createFuncStart, filePath, fs, path

### Community 114 - "fixPageTS.js"
Cohesion: 0.40
Nodes (4): content, filePath, fs, path

### Community 115 - "updateCampfireDetail.js"
Cohesion: 0.40
Nodes (4): content, filePath, fs, path

## Knowledge Gaps
- **506 isolated node(s):** `$schema`, `collection`, `sourceRoot`, `deleteOutDir`, `name` (+501 more)
...
- **Why does `useAppSelector` connect `Client Components Module` to `compilerOptions`, `Client App Module`, `useChat.ts`, `page.tsx`, `CommunitySettingsEntity`, `Client Feed Module`, `page.tsx`, `campfire.module.ts`, `Campfires Client Module`, `page.tsx`, `Client Settings Module`, `Client App Module`, `PresenceService`, `Client Experiences Module`, `AdventureDNA.tsx`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `react` connect `Campfires.tsx` to `Client Booking Module`, `useChat.ts`, `Client Package Module`, `Client Settings Module`, `Client App Module`, `Client Experiences Module`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `CampfireEntity` connect `PostCommentEntity` to `page.tsx`?**
