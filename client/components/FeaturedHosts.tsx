  ...
  return (
    <section className="relative py-10 lg:py-24 px-6 md:px-12 bg-brand-bg max-w-[1440px] mx-auto w-full" id="hosts">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {isLoading 
          ? Array.from({ length: 3 }).map((_, i) => <FeaturedHostSkeletonCard key={i} />)
          : hosts.map((host) => {
...
function FeaturedHostSkeletonCard() {
  return (
    <div className="p-6 rounded-3xl glass-panel border-white/5 flex flex-col justify-between h-[340px] bg-zinc-900/50 animate-pulse">
      <div>
        <div className="flex items-center gap-4 mb-4">
        ...
        <div className="space-y-2 mb-6">
          ...
          <div className="h-3 w-full bg-white/10 rounded-sm" />
          <div className="h-3 w-4/5 bg-white/10 rounded-sm" />
        </div>
      </div>

      <div>
        <div className="grid grid-cols-3 gap-2 py-3 border-t border-b border-white/5 mb-6">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <div className="h-3 w-6 bg-white/10 rounded-sm" />
          </div>
          <div className="flex flex-col items-center gap-2">
