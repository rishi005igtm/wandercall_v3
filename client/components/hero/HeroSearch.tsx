  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center w-full h-12 rounded-full glass-panel border border-white/10 bg-black/40 px-4 transition-all focus-within:border-brand-indigo/50 focus-within:bg-black/60 shadow-xl">
        ...
        />
        <button suppressHydrationWarning className="flex items-center gap-1.5 h-8 px-3 rounded-full bg-brand-indigo/20 text-brand-indigo hover:bg-brand-indigo/30 transition-colors border border-brand-indigo/30 text-[10px] font-bold uppercase tracking-wider shrink-0">
